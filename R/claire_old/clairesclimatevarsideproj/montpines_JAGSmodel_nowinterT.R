...
#monitor# deviance,grwth_intercept,grwth_Transect_randomeffect,surv_Transect_randomeffect,grwth_dbhCoef,grwth_TempMaySeptCoef,grwth_PrecipAugJulyCoef,grwth_fogCoef,grwth_cloudCoef,grwthvar_intercept,surv_intercept,surv_dbhCoef,surv_TempMaySeptCoef,surv_PrecipAugJulyCoef,surv_fogCoef,surv_cloudCoef
#modules# glm on
#response# DBH
#residual# regression_residual
#fitted# regression_fitted
#data# Ncases,Ngrowcases,goodrows,goodgrowrows,lagvals,DBH,TempMaySept,PrecipAugJuly,fog,cloud,transect.num
